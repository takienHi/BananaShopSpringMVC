...
! function(t, e) {
	...
	var e = function() {
			...
			return e.prototype.render = function(e) {
				var o = t(this.markup);
				if (this.options && this.options.contents && o.html(this.options.contents), this.options && this.options.className && o.addClass(this.options.className), this.options && this.options.data && t.each(this.options.data, function(t, e) {
						o.attr("data-" + t, e)
		...
		i = o('<div class="note-toolbar-wrapper"><div class="note-toolbar card-header" role="toolbar"></div></div>'),
		r = o('<div class="note-editing-area"/>'),
		s = o('<textarea class="note-codable" role="textbox" aria-multiline="true"/>'),
		a = o('<div class="note-editable card-block" contentEditable="true" role="textbox" aria-multiline="true"/>'),
		l = o(['<output class="note-status-output" aria-live="polite"/>', '<div class="note-statusbar" role="status">', '  <output class="note-status-output" aria-live="polite"></output>', '  <div class="note-resizebar" role="seperator" aria-orientation="horizontal" aria-label="Resize">', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', '    <div class="note-icon-bar"/>', "  </div>", "</div>"].join("")),
		...
		h = o('<div class="dropdown-menu" role="list">', function(e, o) {
			var n = t.isArray(o.items) ? o.items.map(function(t) {
				...
				return '<a class="dropdown-item" href="#" ' + ('data-value="' + e + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ' role="listitem" aria-label="' + t + '">' + n + "</a>"
			}).join("") : o.items;
			e.html(n).attr({
				"aria-label": o.title
			})
		}),
		p = o('<div class="dropdown-menu note-check" role="list">', function(e, o) {
			var n = t.isArray(o.items) ? o.items.map(function(t) {
				var e = "string" == typeof t ? t : t.value || "",
					n = o.template ? o.template(t) : t;
				return '<a class="dropdown-item" href="#" data-value="' + e + '" role="listitem" aria-label="' + t + '">' + b(o.checkClassName) + " " + n + "</a>"
			}).join("") : o.items;
			e.html(n).attr({
				"aria-label": o.title
			})
		...
		v = o('<label class="custom-control custom-checkbox"></label>', function(t, e) {
			e.id && t.attr("for", e.id), t.html([' <input role="checkbox" type="checkbox" class="custom-control-input"' + (e.id ? ' id="' + e.id + '"' : ""), e.checked ? " checked" : "", ' aria-checked="' + (e.checked ? "true" : "false") + '"/>', ' <span class="custom-control-indicator"></span>', ' <span class="custom-control-description">' + (e.text ? e.text : "") + "</span>", "</label>"].join(""))
		}),
		b = function(t, e) {
		...
		y = {
			...
			createLayout: function(t, e) {
				var o = (e.airMode ? y.airEditor([y.editingArea([y.airEditable()])]) : y.editor([y.toolbar(), y.editingArea([y.codable(), y.editable()]), y.statusbar()])).render();
	...
	var N = {
			...
			clusterBy: function(t, e) {
				return t.length ? S(t).reduce(function(t, o) {
					var n = x(t);
					return e(x(n), o) ? n[n.length] = o : t[t.length] = [o], t
				}, [
					[w(t)]
				]) : []
			},
	...
	var A, R = navigator.userAgent,
		P = /MSIE|Trident/i.test(R);
	if (P) {
		var L = /MSIE (\d+[.]\d+)/.exec(R);
		L && (A = parseFloat(L[1])), (L = /Trident\/.*rv:([0-9]{1,}[.0-9]{0,})/.exec(R)) && (A = parseFloat(L[1]))
	}
	var H = /Edge\/\d+/.test(R),
		D = !!window.CodeMirror;
	if (!D && E)
		if ("function" == typeof __webpack_require__) try {
			...
			if (void 0 !== require.resolve) try {
				require.resolve("codemirror"), D = !0
			} catch (t) {} else void 0 !== require.specified && (D = require.specified("codemirror"));
	...
	function xt(t, e, o) {
		var n = lt(e.node, C.eq(t));
		return n.length ? 1 === n.length ? wt(e, o) : n.reduce(function(t, n) {
			return t === e.node && (t = wt(e, o)), wt({
				node: n,
				offset: t ? vt(t) : it(n)
			}, o)
		}) : null
	...
	var Nt = {
		...
		listDescendant: function(t, e) {
			...
			return e = e || C.ok,
				function n(i) {
					t !== i && e(i) && o.push(i);
					for (var r = 0, s = i.childNodes.length; r < s; r++) n(i.childNodes[r])
				}(t), o
		},
	...
	var Et = {
		...
		At = {
			...
			nameFromCode: C.invertObject(Et),
			code: Et
		};
	...
	var Lt = function() {
			...
			return e.prototype.nativeRange = function() {
				...
				return e.setEndPoint("EndToEnd", Pt({
					node: this.ec,
					offset: this.eo
				})), e
				...
				var o = t(e).height();
				return e.scrollTop + o < this.sc.offsetTop && (e.scrollTop += Math.abs(e.scrollTop + o - this.sc.offsetTop)), this
				...
				return Nt.walkPoint(i, r, function(e) {
					var i;
					Nt.isEditable(e.node) || (n ? (Nt.isLeftEdgePoint(e) && a.push(e.node), Nt.isRightEdgePoint(e) && N.contains(a, e.node) && (i = e.node)) : i = o ? Nt.ancestor(e.node, t) : e.node, i && t(i) && s.push(i))
				}, !0), N.unique(s)
				...
				return function() {
					...
					return !!e && e === Nt.ancestor(this.ec, t)
				}
				...
				var t, o = this.normalize();
				if (Nt.isParaInline(this.sc) || Nt.isPara(this.sc)) return o;
				if (Nt.isInline(o.sc)) {
					var n = Nt.listAncestor(o.sc, C.not(Nt.isInline));
					t = N.last(n), Nt.isInline(t) || (t = n[n.length - 2] || o.sc.childNodes[o.so])
				} else t = o.sc.childNodes[o.so > 0 ? o.so - 1 : 0];
				var i = Nt.listPrev(t, Nt.isParaInline).reverse();
				if ((i = i.concat(Nt.listNext(t.nextSibling, Nt.isParaInline))).length) {
				...
				if (!Nt.isCharPoint(o)) return this;
				var n = Nt.prevPointUntil(o, function(t) {
		...
		Ht = {
			create: function(t, e, o, n) {
				...
				if (2 === arguments.length) return new Lt(t, e, o = t, n = e);
				var i = this.createFromSelection();
				return i || 1 !== arguments.length ? i : (i = this.createFromNode(arguments[0])).collapse(Nt.emptyPara === arguments[0].innerHTML)
			},
	...
	var Dt = function() {
		...
		Ft = function() {
			function e() {}
			return e.prototype.jQueryCSS = function(e, o) {
		...
		Bt = function() {
			...
			return e.prototype.insertOrderedList = function(t) {
				...
				t.each(r, function(e, n) {
					var i = N.head(n);
					Nt.isLi(i) ? o.wrapList(n, i.parentNode.nodeName) : t.each(n, function(e, o) {
				...
				t.each(r, function(e, n) {
					var i = N.head(n);
					Nt.isLi(i) ? o.releaseList([n]) : t.each(n, function(e, o) {
						t(o).css("marginLeft", function(t, e) {
				...
				return t.each(e, function(e, i) {
					var r = N.head(i),
						...
						l = a.childNodes.length > 1 ? Nt.splitTree(a, {
							node: s.parentNode,
							offset: Nt.position(s) + 1
						}, {
							isSkipPaddingBlankHTML: !0
						}) : null,
						c = Nt.splitTree(a, {
							node: r.parentNode,
							offset: Nt.position(r)
						}, {
							isSkipPaddingBlankHTML: !0
						});
					i = o ? Nt.listDescendant(c, Nt.isLi) : N.from(c.childNodes).filter(Nt.isLi), !o && Nt.isList(a.parentNode) || (i = i.map(function(t) {
			...
			return e.prototype.insertTab = function(t, e) {
				...
				if (i) {
					...
					if (Nt.isEmpty(i) && Nt.isPara(i) && Nt.isBlockquote(i.parentNode)) Nt.insertAfter(i, i.parentNode), n = i;
						...
						r = r.concat(Nt.listDescendant(n, Nt.isEmptyAnchor)), t.each(r, function(t, e) {
							Nt.remove(e)
	...
	var Ot, Ut = function() {
			...
			return e.prototype.tab = function(t, e) {
				...
				if ("top" === o) i.before(s);
					...
					if (n.rowSpan > 1) {
						var p = i[0].rowIndex + (n.rowSpan - 2);
						return void t(t(i).parent().find("tr")[p]).after(t(s))
					}
					i.after(s)
				}
		...
		jt = function() {
			function e(e) {
				...
				for (var n = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor"], i = 0, r = n.length; i < r; i++) this[n[i]] = function(t) {
					return function(e) {
				...
				for (i = 1; i <= 6; i++) this["formatH" + i] = function(t) {
					return function() {
						o.formatBlock("H" + t)
					}
				...
				this.insertParagraph = this.wrapCommand(function() {
					...
					o.style.stylePara(o.createRange(), {
						lineHeight: t
					})
			...
			return e.prototype.initialize = function() {
				...
				var n, i = this;
				return (n = e, t.Deferred(function(e) {
					var o = t("<img>");
					o.one("load", function() {
				...
				t.each(e, function(e, n) {
					var i, r = n.name;
					o.options.maximumImageFileSize && o.options.maximumImageFileSize < n.size ? o.context.triggerEvent("image.upload.error", o.lang.image.maximumFileSizeError) : (i = n, t.Deferred(function(e) {
				...
				var t = this.createRange();
				return t.isOnAnchor() && (t = Ht.createFromNode(Nt.ancestor(t.sc, Nt.isAnchor))), t.toString()
			...
			return e.prototype.initialize = function() {
				...
				this.documentEventHandlers.onDragenter = function(t) {
					...
					o.preventDefault(), n && n.files && n.files.length ? (e.$editable.focus(), e.context.invoke("editor.insertImagesOrCallback", n.files)) : t.each(n.types, function(o, i) {
						var r = n.getData(i);
						i.toLowerCase().indexOf("text") > -1 ? e.context.invoke("editor.pasteHTML", r) : t(r).each(function(t, o) {
	...
	var Vt = function() {
			...
			return t.prototype.sync = function() {
				...
				if (this.$codable.val(Nt.html(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), z.hasCodeMirror) {
					...
					if (this.options.codemirror.tern) {
						...
						e.ternServer = o, e.on("cursorActivity", function(t) {
							o.updateArgHints(t)
						})
					}
		...
		Xt = function() {
			...
			return e.prototype.representShortcut = function(t) {
				...
				this.context.memo("button.bold", function() {
					...
					return t.each(o["font-family"].split(","), function(o, n) {
						...
						children: [e.button({
							...
							callback: function(o) {
								o.find(".note-holder").each(function(o, n) {
									var i = t(n);
									i.append(e.ui.palette({
										colors: e.options.colors,
										colorsName: e.options.colorsName,
				...
				for (var n = 0, i = o.length; n < i; n++) {
					for (var r = o[n], s = t.isArray(r) ? r[0] : r, a = t.isArray(r) ? 1 === r.length ? [r[0]] : r[1] : [r], l = this.ui.buttonGroup({
							className: "note-" + s
						}).render(), c = 0, d = a.length; c < d; c++) {
				...
				s.css({
					width: c + "em",
					height: d + "em"
				}), r.data("value", c + "x" + d), c > 3 && c < this.options.insertTableMaxSize.col && a.css({
					width: c + 1 + "em"
				}), d > 3 && d < this.options.insertTableMaxSize.row && a.css({
					height: d + 1 + "em"
				}), i.html(c + " x " + d)
			}, e
		}(),
		te = function() {
			...
			return e.prototype.shouldInitialize = function() {
				...
				s > a - r && s < a + o - r - i ? this.$toolbar.css({
					position: "fixed",
					top: r,
					width: n
				}) : this.$toolbar.css({
				...
				return t.Deferred(function(t) {
					...
					o.ui.onDialogShown(o.$dialog, function() {
						...
						i.on("input", l).on("paste", function() {
							setTimeout(l, 0)
						}).val(e.url), z.isSupportTouch || i.trigger("focus"), o.toggleLinkBtn(r, n, i), o.bindEnterKey(i, r), o.bindEnterKey(n, r);
		...
		ae = function() {
			...
			return e.prototype.initialize = function() {
				var t = this.options.dialogsInBody ? this.$body : this.$editor,
					e = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.10</a> · ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
				this.$dialog = this.ui.dialog({
				...
				var e = this,
					o = this.options.keyMap[z.isMac ? "mac" : "pc"];
				return Object.keys(o).map(function(n) {
					var i = o[n],
						r = t('<div><div class="help-list-item"/></div>');
					return r.append(t("<label><kbd>" + n + "</kdb></label>").css({
						width: 180,
						"margin-right": 10
					})).append(t("<span/>").html(e.context.memo("help." + i) || i)), r.html()
				}).join("")
		...
		ce = function() {
			...
			return e.prototype.shouldInitialize = function() {
				...
				return o.map(function(o, i) {
					var r = t('<div class="note-hint-item"/>');
					return r.append(n.template ? n.template(o) : o + ""), r.data({
						index: e,
						item: o
					}), r
				})
				...
				if (!N.contains([At.code.ENTER, At.code.UP, At.code.DOWN], t.keyCode)) {
					...
					if (this.hints.length && n) {
						...
						i && (this.$popover.hide(), this.lastWordRange = o, this.hints.forEach(function(t, o) {
	...
	t.fn.extend({
		summernote: function() {
			...
			i.langInfo = t.extend(!0, {}, t.summernote.lang["en-US"], t.summernote.lang[i.lang]), i.icons = t.extend(!0, {}, t.summernote.options.icons, i.icons), i.tooltip = "auto" === i.tooltip ? !z.isSupportTouch : i.tooltip, this.each(function(e, o) {
				var n = t(o);
